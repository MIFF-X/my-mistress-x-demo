...
export function LiveRoomLockedState({
  title = 'Room Locked',
  subtitle = 'This room needs a ticket, membership, invite code, or Mistress approval before entry.',
  accessLabel = 'Access required',
  primaryLabel = 'Unlock Access',
  secondaryLabel = 'Request Invite',
  onPrimaryPress,
  onSecondaryPress,
}: LiveRoomLockedStateProps) {
  return (
    <View
      style={{
